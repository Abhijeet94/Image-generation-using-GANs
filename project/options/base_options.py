...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', type = str, default = '/content/gdrive/My Drive/FACADE_data', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--name', type=str, default='FACADE_cycle_gan', help='name of the experiment. It decides where to store samples and models')
